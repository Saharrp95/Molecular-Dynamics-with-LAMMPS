...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 13 14:44:55 2023
...
df = pd.read_csv('//Users/sahar/Documents/classes/Computational_material/HW3/result/with Press/plot/E-time(press).csv', header=0, names=['Step', 'TotEng'])
...
plt.plot(time, TotEng, label='Energy', color='blue', linewidth=0.5)
