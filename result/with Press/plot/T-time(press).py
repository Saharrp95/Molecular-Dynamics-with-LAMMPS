...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 13 14:35:16 2023
...
df = pd.read_csv('//Users/sahar/Documents/classes/Computational_material/HW3/result/with Press/plot/T-time(press).csv', header=0, names=['Step', 'Temp'])
...
plt.plot(time, Temp, label='Temp', color='blue', linewidth=0.5)
